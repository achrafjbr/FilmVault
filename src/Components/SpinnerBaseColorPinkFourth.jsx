export default function SpinnerBaseColorPinkFourth() {
  return (
    <>
      {/*<!-- Component: Colored pink base sized 1/4 spinner --> */}
      <svg
        viewBox="0 0 24 24"
        fill="none"
      ...
      >
        ...
        <path
          ...
          className="stroke-pink-500 flex justify-center items-center"
          strokeWidth="4"
        />
      </svg>
      {/*<!-- End Colored pink base sized 1/4 spinner --> */}
    </>
  );
}
